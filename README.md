...
**进化方案 v1（Implemented）：** 见 [`docs/EVOLUTION_PLAN.md`](docs/EVOLUTION_PLAN.md) — PR-A…E 已落地（流隔离、GuestSlot、FailurePolicy/HITL、Executor 策略、claim envelope/verify/export）；后续 backlog 见 §15。
...
| [`docs/EVOLUTION_PLAN.md`](docs/EVOLUTION_PLAN.md) | 进化方案 v1 规格与 §15 backlog |