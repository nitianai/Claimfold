...
**实验记录与结论：** 见 [`EXPERIMENTS.md`](EXPERIMENTS.md)（项目初心文档，持续更新）。
...
council/
  ...
  prompts/
    ...
    market_context_prompt.md
    guest_prompt_json.md
    summarizer_prompt_template.md
  meetings/<meeting_id>/
    meeting_state.json
...
- `prompts/council_investment_report_template.md`
- `prompts/council_experiment_report_template.md`
...
| 文档 | 内容 |
|------|------|
| [`EXPERIMENTS.md`](EXPERIMENTS.md) | 实验设计、实测数据、结论、Phase 2 计划 |
| [`CLAIM_LIFECYCLE.md`](CLAIM_LIFECYCLE.md) | 主张生命周期规范 V0.2 |