...
**进化方案 v1：** 见 [`docs/EVOLUTION_PLAN.md`](docs/EVOLUTION_PLAN.md) — PR-A…E + §15/§16 backlog 已全部完成；新需求开 v2 backlog。
...
| [`docs/EVOLUTION_PLAN.md`](docs/EVOLUTION_PLAN.md) | 进化方案 v1（已完成）；§17 V0.2 封板记录 |