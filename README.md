...
**v2 路线：** 见 [`docs/V2_BACKLOG.md`](docs/V2_BACKLOG.md) — Phase 5 ✅ → Phase 6 产品化（[`日常运行手册`](docs/DAILY_OPS.md) 已就绪）。
...
| `claim verify` | 三场会议链 + index 重建不变量验收 |
| `web` | 启动会议室 Web UI（默认 `http://127.0.0.1:8787`） |
...
> **状态：** **V0.2 已封板**（2026-07-12）— §6 交付、§7 三场会议验收、Phase 2（E1–E5）、实验 H 黄金复验均通过。规范见 [`docs/CLAIM_LIFECYCLE.md`](docs/CLAIM_LIFECYCLE.md)。
...
| [`docs/DAILY_OPS.md`](docs/DAILY_OPS.md) | **日常运行**：Web、daemon、run-daily、systemd |
| [`docs/V2_BACKLOG.md`](docs/V2_BACKLOG.md) | v2 路线：平台硬化 → 产品化 |
| [`docs/EVOLUTION_PLAN.md`](docs/EVOLUTION_PLAN.md) | 进化方案 v1（已完成）；§17 V0.2 封板 |
| [`docs/PLATFORM_APP_SPLIT.md`](docs/PLATFORM_APP_SPLIT.md) | Platform / App 拆分（Phase 0–4 ✅，Phase 5 进行中） |