...
from council.config import MEETING_PLAN_FILENAME, ROOT
...
FIXTURE_BINDINGS = ROOT / "tests" / "fixtures" / "plan" / "project-bindings.yaml"
...
def test_scenario_start_writes_meeting_plan_json():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        (scenario_dir / "project-development.yaml").write_text(
            (ROOT / "scenarios" / "project-development.yaml").read_text(encoding="utf-8"),
            encoding="utf-8",
        )
